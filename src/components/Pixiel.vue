<template>
  <div ref="pixiel" class="pixiel">
    ...
    <div class="color-picker">
      <div v-for="item in colorList" :key="item.name" class="block">
        <el-color-picker v-model="colorManage[item.name]" @change="(val) => onChange(val, item.name)"></el-color-picker>
...
export default {
  ...
  methods: {
    onChange(val, color) {
      ...
      this.$refs.pixiel.style.setProperty(`--${color}`, val)
    }
  }
};
</script>
...
$cat: (
  ...
  ($t, $black, $dkgray, $gray, $gray, $gray, $gray, $gray, $gray, $gray, $gray, $dkgray, $black, $t, $t, $t, $t, $t, $t, $black, $gray, $gray, $black ),
